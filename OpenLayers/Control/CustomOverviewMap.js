 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.CustomOverviewMap = OpenLayers.Class(OpenLayers.Control, {
    ...
    /**
     * APIProperty: viewFixed
     * {Boolean}  This property is used to prevent the map from panning
     * and zooming when the main map is modified. Defaults to true.
     */ 
    viewFixed : true,

    /**
     * APIProperty: fixedZoomLevel
     * {Number}  This property is used to specify a zoom level to use
     * when the <viewFixed> parameter if view.
     */ 
    fixedZoomLevel : 7,
    ...
    update: function() {
        if(this.ovmap == null) {
            ...
            if(this.viewFixed) {
                this.updateOverview();
                this.ovmap.zoomTo(this.fixedZoomLevel);    
            }
    ...
    // We keep the name to reuse the styles!
