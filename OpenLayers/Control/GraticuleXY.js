...
/**
 * Class: OpenLayers.Control.GraticuleXY
 * The GraticuleXY displays a grid of x/y lines
 * the map.
 *
 * Inherits from:
 *  - <OpenLayers.Control>
 *
 */
OpenLayers.Control.GraticuleXY = OpenLayers.Class(OpenLayers.Control, {
    ...
    */
    intervals: [ 10000000, 5000000, 2000000, 1000000, 500000, 200000, 100000, 50000, 20000, 10000, 5000, 2000, 1000, 500, 200, 100, 50, 20, 10, 5, 2, 1],
     ...
     * {Boolean} Allows the Graticule control to have a projection. Default is null
     */
    projection: null,
    ...
    update: function() {
        ...
        //var llProj  = this.map.getProjectionObject(); //new OpenLayers.Projection("EPSG:4326");
        var llProj = new OpenLayers.Projection("EPSG:32719");
