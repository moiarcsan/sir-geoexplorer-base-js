...
/** api: constructor
 *  .. class:: MeasureLength(config)
 *
 *    Provides measuring length.
 */
gxp.plugins.MeasureLength = Ext.extend(gxp.plugins.CustomMeasure, {
    ...
    constructor: function(config) {
        gxp.plugins.MeasureLength.superclass.constructor.apply(this, arguments);
    },
    ...
    addActions: function() {
        ...
        return gxp.plugins.CustomMeasure.superclass.addActions.apply(this, [{
            ...
            menuText: this.legthMenuText,
            iconCls: "gxp-icon-measure-length",
            tooltip: this.lengthTooltip,
...
Ext.preg(gxp.plugins.MeasureLength.prototype.ptype, gxp.plugins.MeasureLength);
