...
Viewer.widgets.SearchByCoordinates = Ext.extend(Ext.TabPanel, {
    ...
    constructor: function(config) {
        ...
        Viewer.widgets.SearchByCoordinates.superclass.constructor.call(this, Ext.apply({
    ...
    onBtnUtmClicked: function() {
        ...
        var point = new OpenLayers.LonLat(
            this.txtUtmX.getValue(),
            this.txtUtmY.getValue()
        );
    ...
    onBeforeRender: function() {
        ...
        this.txtUtmX = new Ext.form.NumberField({ name: 'utm_x', fieldLabel: 'X', decimalPrecision: Viewer.UTM_PRECISION });
        this.txtUtmY = new Ext.form.NumberField({ name: 'utm_y', fieldLabel: 'Y', decimalPrecision: Viewer.UTM_PRECISION });
        ...
        this.txtLonDeg = new Ext.form.NumberField({ name: 'lon_deg', fieldLabel: 'Longitud', flex: 1, decimalPrecision: 0 });
        this.txtLonMin = new Ext.form.NumberField({ name: 'lon_min', flex: 1, decimalPrecision: 0 });
        this.txtLonSec = new Ext.form.NumberField({ name: 'lon_sec', flex: 1, decimalPrecision: Viewer.SECONDS_PRECISION });
        this.cmbEast = new Ext.form.ComboBox(Ext.apply({ name: 'east', store: storeEast }, cmbConfig));
        this.txtLatDeg = new Ext.form.NumberField({ name: 'lat_deg', fieldLabel: 'Latitud', flex: 1, decimalPrecision: 0 });
        this.txtLatMin = new Ext.form.NumberField({ name: 'lat_min', flex: 1, decimalPrecision: 0 });
        this.txtLatSec = new Ext.form.NumberField({ name: 'lat_sec', flex: 1, decimalPrecision: Viewer.SECONDS_PRECISION });
        this.cmbNorth = new Ext.form.ComboBox(Ext.apply({ name: 'north', store: storeNorth }, cmbConfig));
        ...
        this.txtLonDecimal = new Ext.form.NumberField({ name: 'lon_decimal', fieldLabel: 'Longitud', decimalPrecision: Viewer.DEGREES_PRECISION });
        this.txtLatDecimal = new Ext.form.NumberField({ name: 'lat_decimal', fieldLabel: 'Latitud', decimalPrecision: Viewer.DEGREES_PRECISION });
