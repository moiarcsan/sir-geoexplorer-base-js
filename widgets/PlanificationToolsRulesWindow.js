...
(function () {
    ...
    Viewer.dialog.PlanificationToolsRulesWindow = Ext.extend(Ext.Window, {
        ...
        constructor : function (config) {
            ...
            Viewer.dialog.PlanificationToolsRulesWindow.superclass.constructor
                    .call(this, Ext.apply({
        ...
        onBeforeRender : function () {
            ...
            var c = {
                ...
                buttons : [ this.btnClose = new Ext.Button({
                    text : 'Cerrar',
                    listeners : {
    ...
    Ext.reg('vw_planification_tools_layer_window',
            Viewer.dialog.PlanificationToolsRulesWindow);

    Viewer.widgets.PlanificationToolsLayerRules = Ext
            .extend(
                    Ext.Panel,
                    {
                        ...
                        constructor : function (config) {
                            ...
                            Viewer.widgets.PlanificationToolsLayerRules.superclass.constructor
                                    .call(this, Ext.apply({
                                        border : false,
                                        layout : {
                                            type : 'accordion',
                        ...
                        ººº     ";
                            ...
                            url += [
                                    ...
                                    'SERVICE=WMS',
                                    'VERSION='
                                            + window.app.sources.local.baseParams.VERSION,
                                    ...
                                    'SCALE=1091958.1364361627', 'OPACITY=0' ]
                                    .join('&');
                        ...
                        getStyles : function (layer, callback) {
                            ...
                            var layerParam = [ layer.params.LAYERS ].join(',');
                            Ext.Ajax.request({
                                url : layer.url,
                                params : {
                                    'SERVICE' : 'WMS',
                        ...
                        createDataRecord : function (rule) {
                            ...
                            for ( var s in rule.symbolizer) {
                                try {
                                    ...
                                    var symbolizer = new Constructor(
                                            rule.symbolizer[s]);
    ...
    Ext.reg('vw_planification_tools_layer_rules',
            Viewer.widgets.PlanificationToolsLayerRules);
